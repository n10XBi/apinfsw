(() => {
    ...
    async function validateApiKey(env, request, url) {
        ...
        // Ambil API key dari header/query
        ...
        // Ambil record dari KV (sama dengan mangement)
        ...
        // increment usage
        rec.usage += 1;
        await env["Gen-api-txt2img"].put(key, JSON.stringify(rec));
